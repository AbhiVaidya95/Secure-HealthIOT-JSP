...
<!DOCTYPE html>
<html>
<title>Secure Health IOT - Select Doctor</title>
...
<%}%>
  ...
  <form name="form" method="post" action="w3sdoc.jsp" class="w3-container">
  <!--
 <label>Doctor ID</label>
  <input class="w3-input" type="text" name="textfield1" placeholder="DR1,DR2,...">

	-->
<label class="w3-label w3-text-blue"><b>Doctor ID</b></label>
  <input class="w3-input w3-border w3-light-grey" type="text" placeholder="DR1,DR2,..." name="textfield1">
