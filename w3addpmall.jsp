...
<!DOCTYPE html>
<html>
<title>Secure Health IOT Enter Medecines Allergies</title>
...
<div>    
  ...
  <h2>Enter Medicenes Allergies</h2>
    </div>
      <form name="form" method="post" action="w3apmal.jsp" class="w3-container">

 

 <p> <label>Medicines Allergies</label></p>

 <p> <!--<input  type="text" name="textfield1" placeholder="Crocine,Sumo,Zentac" rows="4" cols="50"></p>-->
<textarea name="textarea1" rows="3" maxlength="200" cols="60" placeholder="Crocine,Nise,Zentac"></textarea></p>
