...
<!DOCTYPE html>
<html>
<title>Secure Health IOT Enter Medecines Consumed</title>
...
<div>    
  ...
  <h2>Enter Medicenes Consumed</h2>
    </div>
      <form name="form" method="post" action="w3apm.jsp" class="w3-container">

 <p>

  <label>Medicines Consumed</label>
  </p>
  <p>
 <textarea name="textfield1" rows="3" maxlength="200" cols="60" placeholder="Crocine,Nise,Zentac"></textarea></p>
