...
<!DOCTYPE html>
<html>
<title>Secure Health IOT View Patient Medecine Allgeric</title>
...
<div>    
  ...
  <h2>Search Patient Medicine Allergic</h2>
    </div>
      <form name="form" method="post" action="w3vpmallr.jsp" class="w3-container">
