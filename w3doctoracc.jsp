...
<div>    
  <div class="w3-row">
    ...
    <div class="w3-col m8 w3-container"> 
      <h1>Welcome</h1><%=session.getAttribute("doctorid") %>
      <!--
  ...
  <h4>Create Username and Password for</h4><%=session.getAttribute("doctorid") %>
    </div>
      <form name="form" method="post" action="w3adddrlogin.jsp" class="w3-container">
