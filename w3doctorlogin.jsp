...
<!DOCTYPE html>
<html>
<title>Secure Health IOT - Doctor Login</title>
...
<div class="w3-center">    
  <div class="w3-row">
    ...
    <h1>Doctor <br>Log-in</h1><br>
  <form name="form" method="post" action="naw3.jsp">
     <input type="text" name="textfield1" placeholder="Doctor ID" required>
