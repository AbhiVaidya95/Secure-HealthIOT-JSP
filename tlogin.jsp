...
<div class="container-fluid text-center">    
  ...
  <div class="row content">
    ...
    <h1>Log-in</h1><br>
  <form name="form" method="post" action="naw1.jsp">


     <label class="radio-inline"><input type="radio" name="r1">Patient</label>
<label class="radio-inline"><input type="radio" name="r1">Doctor</label>
<br/>
<br/>
    <input type="text" name="textfield1" placeholder="Username" required>
