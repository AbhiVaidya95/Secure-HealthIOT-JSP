...
<!DOCTYPE html>
<html>
<title>Secure Health IOT - Patient Login</title>
...
<div class="w3-topnav w3-large w3-blue">
  <a href="w3index.jsp">Secure Health IOT</a>
   <div class="w3-right">
  <a href="w3index.jsp">Home</a>
  <!--
...
<div class="w3-center">    
  <div class="w3-row">
    ...
    <h1>Patient Log-in</h1><br>
  <form name="form" method="post" action="naw2.jsp">
     <input type="text" name="textfield1" placeholder="Patient ID" required>
    <input type="text" name="textfield2" placeholder="Username" required>
    <input type="password" name="textfield3" placeholder="Password" required>
