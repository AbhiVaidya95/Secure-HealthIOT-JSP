...
<div >    
  ...
  <h2>Update Patient Basic Record</h2>
    </div>
      <form name="form" method="post" action="w3upr.jsp" class="w3-container">

       <label>Patient ID</label>
  <input class="w3-input" type="text" name="numfield" placeholder="PT1">
